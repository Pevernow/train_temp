# PowerShell script converted from demo-training-run.sh
...
$DS_BUCKET_MB = 2 # set to 2 for consumer GPUs, set to 200 for A100 / H100
...
python train.py --load_model "0" --wandb "Test" --proj_dir $PROJ_DIR --my_testing $MODEL_TYPE `
 ...
 --data_file "train" --my_exit_tokens 1498226207 --magic_prime 2926181 `
